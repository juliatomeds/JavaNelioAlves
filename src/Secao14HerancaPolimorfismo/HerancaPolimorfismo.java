package application;
import Secao14HerancaPolimorfismo.entities.Account;
import Secao14HerancaPolimorfismo.entities.BusinessAccount;
import Secao14HerancaPolimorfismo.entities.SavingsAccount;
...
public class HerancaPolimorfismo {
    ...
    public static void main(String[] args) {
        ...
        //Polimorfismo
        Secao14HerancaPolimorfismo.entities.Account x = new Secao14HerancaPolimorfismo.entities.Account(1020, "Alex", 1000.0);
        Secao14HerancaPolimorfismo.entities.Account y = new SavingsAccount(1023, "Maria", 1000.0, 0.01);
        x.withdraw(50.0);
